...
@Component({
  ...
  standalone: true,
  imports: [IonContent,CompanybannersComponent,IonToolbar,IonSegment,IonSegmentButton,IonLabel,NgIf,CompanyaboutComponent,CompanymediaComponent,CompanyteamComponent,CompanyeventsComponent,CompanycertificatesComponent,CompanybranchesComponent,IonImg,IonButtons,IonIcon,IonHeader,AsyncPipe],
