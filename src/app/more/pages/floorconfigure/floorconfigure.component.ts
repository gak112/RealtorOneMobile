...
import { ModalController ,IonHeader, IonToolbar, IonIcon, IonTitle, IonContent, IonInput, IonLabel, IonImg, IonFooter, IonButton } from '@ionic/angular/standalone';
...
export class FloorconfigureComponent  implements OnInit {
  ...
  submit() {
    ...
    const ventureTowersRef = this.afs.firestore.collection(`ventureTowers/${this.floor.towerId}/floors`).doc(this.floor.id);
