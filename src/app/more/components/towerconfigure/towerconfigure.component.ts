...
@Component({
  ...
  standalone:true,
  imports:[IonHeader,IonToolbar,IonIcon,IonTitle,IonButton,IonLabel,IonContent,IonImg,NgIf,TowerfloorBoxComponent,NgFor,],
  providers:[ModalController],
})
export class TowerconfigureComponent  implements OnInit {

  @Input()
  tower!: { floors: number; flats: number; id: any; ventureId: any; };
  @Input()
  user!: { uid: any; };
