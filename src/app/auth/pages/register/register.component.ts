...
import { IonButton, IonIcon, IonImg, IonInput, IonLabel, ModalController, NavController } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone:true,
  imports:[IonImg,IonLabel,ReactiveFormsModule,IonInput,NgIf,IonButton,IonIcon,],
